            ...
            child: Column(
              children: [
                                ...
                                Row(
                                  ...
                                  children: [
                                    Text(
                                      ...
                                      style: TextStyle(
                                          fontSize:
                                              11 * SizeConfig.blockSizeVertical,
                                          fontWeight: FontWeight.w400,
                                          color: Colors.black),
                                    ),
                                    Icon(
                ...
                Row(
                  mainAxisSize: MainAxisSize.min,
                  children: [
                    SizedBox(width: 20 * SizeConfig.blockSizeHorizontal,),
                    Text('Browse By Specialization',style: TextStyle(fontSize: 15 * SizeConfig.blockSizeVertical,fontWeight: FontWeight.w600),),
                    Spacer(),
                    Text('See all',style: TextStyle(fontSize: 14 * SizeConfig.blockSizeVertical,fontWeight: FontWeight.w500,color: Color.fromRGBO(1, 166, 157, 1)),),
                ...
                Container(
                  ...
                  child: ListView.separated(
                      ...
                      ), separatorBuilder: (BuildContext context, int index) => Container(width: 15 * SizeConfig.blockSizeHorizontal,),),
                )
